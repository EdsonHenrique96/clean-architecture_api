...
const makeAddAccount = ():AddAccount => {
  class AddAccountStub implements AddAccount {
    async add(account: AddAccountDTO): Promise<AccountModel> { // eslint-disable-line
...
describe('SignUp Controller', () => {
  ...
  test('Should calls addAccount with correct params', async () => {
  ...
  test('should return 200 when AddAccount was successful', async () => {
    const { sut } = makeSut();
